    ...
    <nav class="bg-white fixed w-full z-50 top-0 start-0 shadow">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2  space-x-2 sm:space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button" data-modal-target="login-modal" data-modal-toggle="login-modal" class="text-black bg-white-700 hover:text-[#FF8A01] font-medium rounded-lg text-sm px-4 py-2 text-center">
                    Log in
                </button>
                <button type="button" data-modal-target="signup-modal" data-modal-toggle="signup-modal" class="text-white bg-orange-700 hover:bg-orange-800 font-medium rounded-lg text-sm px-3 sm:px-4 py-2 text-center" 
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
                    <li>
                        <a href="#home" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#FF8A01] md:p-0">
                            Home</a>
                    </li>
                    <li>
                        <a href="#feature" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#FF8A01] md:p-0">
                            Features</a>
                    </li>
                    <li>
                        <a href="#about" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#FF8A01] md:p-0">
                            About Us</a>
                    </li>
                </ul>
            </div>
    ...
    <nav class="bg-white border-gray-200 shadow">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="index.php" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap flex flex-row">
            ...
            <div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                ...
                <!-- Dropdown -->
                <div class="z-50 hidden my-4 text-base list-none w-40 max-w-[160px] bg-white divide-y divide-gray-100 rounded-lg shadow" id="language-dropdown-menu">
                    ...
                    <li>
                        <a href="requests.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
                        <div class="inline-flex items-center">
                    ...
                    <li>
                        <a href="uploads.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
                        <div class="inline-flex items-center">
                    ...
                    <hr>
                    <li>
                        <div data-modal-target="logout-modal" data-modal-toggle="logout-modal" class="flex items-center cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
                ...
                <li>
                    <a href="index.php" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700">
                    Home</a>
                </li>
                <li>
                    <a href="upload_research.php" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700">
                    Files</a>
                </li>
                <li>
                    <a href="surveys.php" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700">
                    Survey</a>
                </li>
                </ul>
            </div>
            ...
            <div class="p-4 md:p-5 text-center flex justify-center items-center flex-col">
                ...
                <div class="w-full flex flex-col justify-center items-center gap-2">
                    <a href="actions/logout.php" class="w-1/2">
                        <button type="button" style="background-color: #FF8A01;" class="w-full py-2.5 px-5 text-sm font-medium text-white focus:outline-none rounded-3xl hover:bg-gray-100  focus:z-10 focus:ring-4 focus:ring-gray-100">
                            Yes, Log Me Out
                        </button>
                    </a>
                    <button data-modal-hide="logout-modal" type="button" class="w-1/2 py-2.5 px-5 text-sm font-medium text-gray-50 focus:outline-none bg-gray-600 rounded-3xl hover:bg-gray-100  focus:z-10 focus:ring-4 focus:ring-gray-100">
                        Cancel  
                    </button>
                </div>
            </div>
