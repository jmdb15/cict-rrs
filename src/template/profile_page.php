<div class="max-auto w-full h-[calc(100vh-64px)] justify-start lg:justify-center gap-x-12 flex flex-col lg:flex-row gap-4">
        ...
        <div class="max-w-[500px] w-full h-[860px] lg:h-[700px] mt-4 lg:mt-0 flex flex-col justify-center place-self-center relative">
            <div class="w-full h-[50px] lg:h-[320px] flex justify-center items-center">
                <img src="../src/img/user.png" class="cursor-pointer w-[100px] h-[100px] md:w-[150px] md:h-[150px] lg:w-[200px] lg:h-[200px] border-2 bg-white border-[#FF8A01] rounded-full absolute top-0 lg:top-28 z-10" alt="pic">
            ...
            <div class="w-full h-[250px] md:h-[320px] lg:h-[520px] bg-white shadow-md rounded-xl flex flex-col justify-center items-center mb-6 lg:mb-32 gap-y-2 relative">
                <p class="font-bold text-sm md:text-md"><?= $first_name . ' ' . substr($middle_name, 0, 1) . ' ' . $last_name ?></p>
                ...
                <div class="w-full flex flex-col gap-10">            
                    <div class="w-full mt-16 flex flex-col items-center justify-center">
                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="w-[150px] py-2 md:py-2.5 px-5 me-2 mb-2 text-xs md:text-md font-medium text-white focus:outline-none bg-[#455A64] rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-[#FF8A01] focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" type="button">
                        Change Profile
                        </button>
                        <button type="button" class="w-[150px] py-2 md:py-2.5 px-5 me-2 mb-2 text-xs md:text-md font-medium text-white focus:outline-none bg-[#455A64] rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-[#FF8A01] focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                    ...
                    <div class="flex flex-row justify-center items-center">
                        ...
                        <p class="text-sm md:text-md lg:text-lg">My points: 24</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-[1200px] w-full h-fit bg-white shadow-md rounded-xl flex justify-center items-center mt-0 lg:mt-24 p-4">
            <div class="w-[95%] h-[90%] z-5">
                <form class="flex flex-col justify-center pb-5 h-full" method="POST">
                        ...
                        <section class="pt-6 flex flex-col w-full disabled">
                            <div class="flex flex-wrap w-full gap-x-8">
                                <div class="flex flex-col gap-x-8 w-full md:w-[400px] lg:w-[348px]">
                                    ...
                                    <input id="first_name" name="first_name" type="text" placeholder="<?=$first_name ?>" class="myInput rounded-xl border-2 p-1 md:p-2 text-sm md:text-md" disabled>
                                </div>
                                <div class="flex flex-col gap-x-8 w-full md:w-[400px] lg:w-[348px]">
                                    ...
                                    <input id="middle_name" name="middle_name" type="text" placeholder="<?= $middle_name ?>" class="myInput rounded-xl border-2 p-1 md:p-2 text-sm md:text-md" disabled>
                                </div>
                                <div class="flex flex-col gap-x-8 w-full md:w-[400px] lg:w-[348px]">
                                    <label for="message" class="block mb-2 text-sm md:text-md font-medium text-gray-900 dark:text-white">Last Name</label>
                                    <input id="last_name" name="last_name" type="text" placeholder="<?=$last_name ?>" class="myInput rounded-xl border-2 p-1 md:p-2 text-sm md:text-md" disabled>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="pt-6 flex flex-col gap-4 w-full disabled">
                            <div class="flex flex-wrap w-full gap-x-4">
                                <div class="flex flex-wrap flex-col gap-x-8 w-full md:w-[500px]">
                                    ...
                                    <select name="" id="" class="myInput rounded-xl w-full p-1 md:p-2 text-sm md:text-md" disabled>
                                ...
                                <div class="flex flex-wrap flex-col gap-x-8 w-full md:w-[300px]">
                                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Specialization</label>
                                    <select name="" id="" class="myInput rounded-xl w-full p-1 md:p-2 text-sm md:text-md" disabled>
                                        <option value="">None</option>
                                        <option value="">Web Dev</option>
                                        <option value="">Bussiness Management</option>
                                        <option value="">Service Daw</option>
                                    </select>
                                </div>
                                ...
                                <div class="flex flex-wrap flex-col gap-x-8 w-full md:w-[100px]">
                                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Section</label>
                                    <select name="" id="" class="myInput rounded-xl w-full p-1 md:p-2 text-sm md:text-md" disabled>                                        
                        ...
                        <section class="pt-6 flex flex-col gap-4 w-full disabled">
                            <div class="flex flex-wrap w-full gap-4">
                                <div class="flex flex-wrap flex-col gap-x-8 w-full md:w-[160px]">
                                    ...
                                    <select name="sex" id="sex" class="myInput rounded-xl border-2 p-1 md:p-2 text-sm md:text-md" disabled>
                                ...
                                <div class="flex flex-wrap flex-col gap-x-8 w-full md:w-[250px]">
                                    ...
                                    <input type="number" placeholder="<?=$id?>" id="#" class="myInput rounded-xl border-2 p-1 md:p-2 text-sm md:text-md" disabled name="#_number" max="10">
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="pt-6 flex flex-col gap-4 w-full disabled">
                            <div class="flex flex-col md:flex-col w-full gap-4">
                                <div class="flex flex-wrap flex-col gap-x-8 w-full md:w-[430px]">
                                    ...
                                    <input type="email" id="email" placeholder="<?=$email ?>" class="myInput rounded-xl border-2 p-1 md:p-2 text-sm md:text-md" disabled>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="pt-6 flex flex-col gap-4 w-full disabled">
                            <div class="flex flex-col md:flex-col w-full gap-4">
                                <div class="flex flex-wrap flex-col gap-x-8 w-full md:w-[430px]">
                                    ...
                                    <input type="email" id="email" placeholder="################" class="myInput rounded-xl border-2 p-1 md:p-2 text-sm md:text-md" disabled>
                                </div>
                            </div>
                        </section>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" method="POST" action="actions/change-pass.php">
                        <div>
                        ...
                        <div class="w-full flex flex-row gap-4">
                            <button type="submit" class="w-1/2 text-white bg-[#FF8A01] hover:bg-white-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" name="changePass">
                                Confirm</button>
                            <button type="submit" class="w-1/2 text-white bg-red-500 hover:bg-white-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        ...
        <div class="relative p-4 w-full max-w-xl max-h-full">
            <div class="relative bg-white rounded-lg drop-shadow-2xl dark:bg-gray-700">
                <div class="p-4 md:p-5 text-center gap-4">
                    ...
                    <form action="changeProfile.php" method="POST" enctype="multipart/form-data" class="w-full flex flex-col gap-16 justify-center items-center">
                        <div class="flex w-24 md:w-36 lg:w-48 bg-gray-500 rounded-full border-4 border-gray-900">
                            <img id="profile-picture" src="../src/img/user.png" onerror="setProfilePic(this)" alt="" class="w-24 md:w-36 lg:w-48 rounded-full">
                        </div>                        
                        <div class="w-full flex flex-col md:flex-row items-center justify-center lg:justify-between gap-2">
                            <div class="flex w-full md:w-1/2 justify-center md:justify-start">
                                ...
                                <button id="file-button" class="py-2.5 px-5 ms-3 text-sm font-medium text-white focus:outline-none bg-[#FF8A01] rounded-lg border border-gray-200  focus:z-10 focus:ring-4 focus:ring-gray-100">Change picture</button>
                            </div>
...
<script>
    ...
    document.getElementById('enableBtn').addEventListener('click', function () {
        ...
        inputFields.forEach(function (inputField) {
            ...
            inputField.classList.remove('bg-gray-800', 'text-white');
            inputField.classList.add('bg-gray-100', 'text-gray-900');
        });
    ...
    document.getElementById('cancelBtn').addEventListener('click', function () {
        ...
        inputFields.forEach(function (inputField) {
            ...
            inputField.classList.remove('bg-gray-100', 'text-gray-900');
        });
    });
