        ...
        <div class="flex justify-between flex-col sm:flex-row gap-y-1 items-center mb-4 px-8 sm:mb-0">
            ...
            <div class="relative max-w-[240px]">
                ...
                <input 
                    ...
                    class="block w-full px-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Research Title | Tags" />
            </div>
        </div>
