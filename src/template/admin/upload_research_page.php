        ...
        <div class="w-full lg:basis-[62%] border h-full py-6 px-12 bg-white shadow rounded-lg">
            ...
            <div class="flex flex-col sm:flex-row justify-around gap-y-6">
                ...
                <div class="w-full sm:basis-1/4 sm:mt-5 lg:basis-[48%] flex justify-center sm:justify-end items-center">
                    <input class="bg-orange-400 cursor-pointer w-full sm:w-auto px-10 py-2 text-white text-sm rounded" type="submit" name="upload" value="Upload">
                </div>
            </div>
...
function displayFile() {
    ...
    const divContent = `<svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                        </svg>
                        <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload</span> or drag and drop</p>
