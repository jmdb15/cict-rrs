                ...
                ?>
                        <tr id="ptr-<?=$row['id']?>" class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-1 sm:px-6 py-4 text-gray-600 flex gap-x-4">
                                <a href="view_study.php?id=<?=$row['id']?>" class="flex gap-1 items-center font-medium text-gray-500 hover:underline">
                ...
                ?>
                        <tr id="tr-<?=$row['id']?>" class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-1 sm:px-6 py-4 text-gray-600 flex gap-x-4">
                                ...
                                <span onclick="archiveFile(<?=$row['id']?>, 1, 'studies')" class="flex gap-1 items-center font-medium text-gray-500 hover:underline">
                    ...
                    renderedHTML = parsed.map(data => {
                        ...
                        if(activeType == 0){
                            ...
                            action = `
                                ...
                                <span onclick="archiveFile(${data.id}, 1, 'studies')" class="flex gap-1 items-center font-medium text-gray-500 hover:underline">
                                    <img src="../../src/img/Archive.svg" alt="">
                                    Archive
                                </span>
                            `;
            ...
            success: function(response){
                if(response === 'success'){
                    ...
                    const lastTd = action === 1 
                        ? `
                            <a href="view_study.php?id=${id}" class="flex gap-1 items-center font-medium text-gray-500 hover:underline">
                                <img src="../../src/img/View.svg" alt="">
                                View
                            </a>
                            <span onclick="archiveFile(${id}, 1, 'studies')" class="flex gap-1 items-center font-medium text-gray-500 hover:underline">
                                <img src="../../src/img/Archive.svg" alt="">
                                Archive
                            </span>
                        `
