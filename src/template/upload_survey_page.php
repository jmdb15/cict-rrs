<main class="w-screen h-fit lg:h-[calc(100vh-80px)] bg-gray-100 dark:bg-slate-700 md:overflow-y-hidden">
    <div class="container h-full mx-auto">
        <!-- Survey Form -->
        <form action="save_survey.php" onsubmit="saveForm(event, this)" method="POST" id="upload-survey-form" class="h-full flex flex-col-reverse justify-center p-4 gap-6 lg:flex-row overflow-y-auto">
            <div class="w-full lg:w-1/2 h-fit flex flex-col p-6 mb-4 gap-y-3 flex-2 bg-white rounded-lg">
                ...
                <div class="w-full my-6 bg-orange-300 p-2">
                    Questions
                </div>
                <div id="form-container" class="w-full relative mx-auto flex flex-col items-end gap-y-2">
                    <button id="add-btn" class="absolute -right-3 top-[86px] rounded-full border-2 border-black p-1 hover:bg-gray-50 hover:brightness-95" onclick="appendFormDiv()">
    ...
    cont.innerHTML += `
        ...
        onblur="handleDivBlur(this)">
            ...
            <div class="w-full border-t border-gray-200 mt-5 pt-3 flex justify-end gap-x-6">
                <button class="" onclick="removeMe(this)">
