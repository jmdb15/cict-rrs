...
if (!isset($_SESSION["id"])) {
  ...
  $sql = "INSERT INTO surveys(survey_name, respondents, url, description, account_id, deadline, filename, is_gforms) VALUES('$name', '$respondents', '$url', '$description', '$uploader', '$deadline', '$surveyCode', 1)";
