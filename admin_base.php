...
<nav class="fixed top-0 z-40 w-full sm:w-[calc(100%-255px)] sm:ml-[255px] bg-white border-b border-gray-200">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-orange-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-200">
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        ...
                        <ul class="py-1" role="none">
                            <li>
                            <a href="../actions/logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Sign out</a>
                            </li>
                        </ul>
                        </div>
                    </div>
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-50 w-64 h-screen mt-[64px] sm:mt-0 pl-5 text-white transition-transform -translate-x-full bg-[#4D4D4D] border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-[#4D4D4D]">
            <a href="#" class="flex py-4 mb-8 ms-2 md:me-24">
                <img src="../../src/img/logo.png" class="h-8 me-3" alt="FlowBite Logo" />
                <span class="self-center text-lg font-semibold sm:text-xl whitespace-nowrap">CICT-<span class="text-orange-400">RRS</span></span>
            </a>
            <ul class="space-y-1 font-medium">
                <li>
                    <a id="dashboard" href="dashboard.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-orange-400 group">
                ...
                <li>
                    <a id="files" href="files.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-orange-400 group">
                ...
                <li>
                    <a id="surveys" href="asurveys.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-orange-400 group">
                ...
                <li>
                    <a id="requests" href="arequests.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-orange-400 group">
                 ...
                 <li>
                    <button id="users" type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-orange-400" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <a href="students.php" class="flex items-center w-full p-2 text-gray-400 transition duration-75 rounded-lg pl-11 group hover:text-white hover:bg-orange-400">Students</a>
                        </li>
                        <li>
                            <a href="faculties.php" class="flex items-center w-full p-2 text-gray-400 transition duration-75 rounded-lg pl-11 group hover:text-white hover:bg-orange-400">Faculty</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a id="logs" href="logs.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-orange-400 group">
    ...
    <?php } ?>
            <div class="w-full flex flex-col justify-center items-center mt-24 md:mt-8 z-50">
                <div class="w-full flex flex-row items-center py-2 px-3 rounded-t-xl bg-white">
                    ...
                    <button type="button" class="ms-auto bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8" data-dismiss-target="#toast-default" aria-label="Close">
